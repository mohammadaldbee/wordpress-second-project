...
<div id="main_class" style="display: flex;">
 ...
 <div class="" id="disable_two_factor_tour" style="width: 50%;margin-top: 1em;">
    ...
    <a href= '<?php echo esc_html($moppm_premium_doc['passwordPolicySettings']);?>' target="_blank">
  ...
  <table class="moppm_table">
    <tbody>
      ...
      <tr>
        ...
        <a href= '<?php echo esc_html($moppm_premium_doc['ExpiryTime']);?>' target="_blank">
        ...
        <a href= '<?php echo esc_html($passwordPolicySettings['ExpiryTime']);?>' target="_blank">
...
<div>
    <table>
      <tbody>
        <tr>
          <td class="moppm_1click_text"><h1>One-click Reset Password </h1><a href= '<?php echo esc_html($moppm_premium_doc['One-clickResetPassword']);?>' target="_blank">
                     ...
                     <a href= '<?php echo esc_html($passwordPolicySettings['One-clickResetPassword']);?>' target="_blank">
...
function displayTab(role){
  ...
  <script>  
            var moppm_Numeric_digit= "<?php echo esc_html(get_site_option('moppm_Numeric_digit'));?>";
             if(moppm_Numeric_digit == 1)
                {
                    jQuery('#moppm_Numeric_digit').prop("checked",1);   
                }

            var moppm_enable_disable_expiry= "<?php echo esc_html(get_site_option('moppm_enable_disable_expiry'));?>";
             if(moppm_enable_disable_expiry == 1)
                {
                    jQuery('#moppm_enable_disable_expiry').prop("checked",1);   
                }
            var moppm_special_char= "<?php echo esc_html(get_site_option('moppm_special_char'));?>";
             if(moppm_special_char == 1)
                {
                    jQuery('#moppm_special_char').prop("checked",1);    
                }
            var moppm_letter= "<?php echo esc_html(get_site_option('moppm_letter'));?>";
             if(moppm_letter == 1)
                {
                    jQuery('#moppm_letter').prop("checked",1);  
                }
            var moppm_first_reset= "<?php echo esc_html(get_site_option('moppm_first_reset'));?>";
             if(moppm_first_reset == 1)
                {
                    jQuery('#moppm_first_reset').prop("checked",1);  
                }
            var moppm_digit= "<?php echo  esc_html(get_site_option('moppm_digit'));?>";
